  ...
  return (
    <>
      ...
      <div className="p-6 grid gap-4 md:grid-cols-3 lg:grid-cols-4">
        <InsightCard label="Total Campaigns" value={insights.total_campaigns} />
        <InsightCard
        ...
        />
        <InsightCard label="Avg CTR" value={formatPercent(insights.avg_ctr)} />
        <InsightCard label="Avg CPC" value={formatCurrency(insights.avg_cpc)} />
        <InsightCard
